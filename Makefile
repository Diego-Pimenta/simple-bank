...
.PHONY: network postgres createdb dropdb new_migration migrateup migrateup1 migratedown migratedown1 db_docs db_schema sqlc test server mock proto evans
