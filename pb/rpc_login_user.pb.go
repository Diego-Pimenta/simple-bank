...
type LoginUserResponse struct {
	...
	SessionsId            string                 `protobuf:"bytes,2,opt,name=sessions_id,json=sessionsId,proto3" json:"sessions_id,omitempty"`
...
func (x *LoginUserResponse) GetSessionsId() string {
	if x != nil {
		return x.SessionsId
	}
	return ""
...
const file_rpc_login_user_proto_rawDesc = "" +
	...
	"\x04user\x18\x01 \x01(\v2\b.pb.UserR\x04user\x12\x1f\n" +
	"\vsessions_id\x18\x02 \x01(\tR\n" +
	"sessionsId\x12!\n" +
	...
	"\x18refresh_token_expires_at\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\x15refreshTokenExpiresAtB)Z'github.com/Diego-Pimenta/simple-bank/pbb\x06proto3"
